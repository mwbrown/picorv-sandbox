...
set(CMAKE_C_FLAGS   "${SPECS_FLAGS} ${RV32_CPU_FLAGS} -ffunction-sections -fdata-sections" CACHE INTERNAL "" FORCE)
set(CMAKE_CXX_FLAGS "${SPECS_FLAGS} ${RV32_CPU_FLAGS} -ffunction-sections -fdata-sections" CACHE INTERNAL "" FORCE)
...
# Define the CMAKE_C_LINK_EXECUTABLE rule because the default
